...
import { Play, Youtube, Shield, BookOpen, Bell, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#030014] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-white/40 text-sm mt-4">Sign in with your Google account to get started</p>
        </div>
