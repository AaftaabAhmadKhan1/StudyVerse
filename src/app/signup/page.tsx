...
export default function SignupPage() {
  ...
  const inputClass =
    'w-full px-4 py-3 bg-[#1a1035] border border-purple-500/10 rounded-xl text-white placeholder-white/20 focus:outline-none focus:border-purple-500/30 text-sm transition-colors';
